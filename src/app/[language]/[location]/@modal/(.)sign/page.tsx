                ...
                <AnimatePresence mode="popLayout" onExitComplete={() => router.back()}>
                    {isModalOpen && (
                        <motion.div
                            ...
                            transition={{ duration: 0.5, ease: "backOut" }}
                            style={{ originY: 0 }}
                            className="p-2 colors absolute z-1000 flex lg:w-md max-lg:w-full max-h-[calc(100%-1rem)] lg:m-auto lg:h-fit lg:inset-0 max-lg:bottom-0 flex-col items-center justify-center lg:rounded-4xl max-lg:rounded-t-4xl lg:border max-lg:border-t border-l5 bg-l1 shadow-lg dark:border-d5 dark:bg-d1"
                        >
